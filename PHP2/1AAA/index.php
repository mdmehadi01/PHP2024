<?php
    ...
    $Connection = mysqli_connect($host,$user,$pass,$dt);
    ...
    if (isset($_POST['submit'])) {
        ...
        $query = "INSERT INTO students (serial,name,board_roll,class_roll,reg_no,phone) VALUES($serial,'$name','$board_roll','$class_roll','$reg_no','$phone')";
