...
<body>
    ...
    <div class="container-fluid p-4 " style="background-color: #F8F9FA; align-items: center; justify-content: center;
     border-top: 1.5px solid #B4B4B4;">
        <div class="row">
            ...
            <div class="fst-normal   fw-lighter   ">
               <h6> Home > Tore > Tore Details > Costa Rica-Classic(Self-Drive)</h6>
            </div>
     ...
     <!--Hero Section -->
     <div class="hero7 d-flex align-items-center justify-content-center text-center text-white" style="height: 400px; position: relative;"> 
